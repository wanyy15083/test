...
<head>
    ...
    <link href="${basePath}/resources/static/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/static/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/static/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="${basePath}/resources/static/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '${basePath}';</script>
<script>var BACK_URL = '${param.backurl}';</script>
<script src="${basePath}/resources/static/js/login.js"></script>
<script>
